...
/*
SubscribeBadRequest Invalid input (e.g., invalid repo format)
...
/*
SubscribeNotFound Repository not found on GitHub
...
/*
SubscribeConflict Email already subscribed to this repository
