...
> **Note**: [swagger.yaml](./api/swagger.yaml) file contains API documentation. You can view it using [Swagger Editor](https://editor.swagger.io/). **Changing the contracts is not allowed.**
...
8. You may use frameworks, but only "thin" solutions. High-level frameworks are prohibited: Revel or Fx (Go). Allowed: net/http (Go), Slim or built-in language capabilities.
